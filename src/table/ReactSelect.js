...
const message = [
    ...
    {
        value: 'Пища на плите без последующего горения',
        label: 'Пища на плите без последующего горения',
        group: 'message'
    },
    ...
    {
        value: 'Взаимодействие с иными службами города',
        label: 'Взаимодействие с иными службами города',
        group: 'message'
    },
    ...
    {
        value: 'Проведение аварийно-спасательных работ',
        label: 'Проведение аварийно-спасательных работ',
        group: 'message'
    },
...
const destination = [
    {
        value: 'Тушение пожаров на объектах производственной сферы',
        label: 'Тушение пожаров на объектах производственной сферы',
        group: 'destination'
    },
    {value: 'Тушение пожаров в жилых зданиях', label: 'Тушение пожаров в жилых зданиях', group: 'destination'},
    {
        value: 'Тушение пожаров в зданиях общественного назначения',
        label: 'Тушение пожаров в зданиях общественного назначения',
        group: 'destination'
    },
    {value: 'Тушение пожаров на транспорте', label: 'Тушение пожаров на транспорте', group: 'destination'},
    {
        value: 'Тушение пожаров строящихся объектов различного назначения',
        label: 'Тушение пожаров строящихся объектов различного назначения',
        group: 'destination'
    },
    {
        value: 'Тушение пожаров на открытых территориях',
        label: 'Тушение пожаров на открытых территориях',
        group: 'destination'
    },
...
const whereWasTheFire = [
    ...
    {
        value: 'На объектах добычи, хранения, переработки нефти, а также магистральных газо и нефтепроводах',
        label: 'На объектах добычи, хранения, переработки нефти, а также магистральных газо и нефтепроводах',
        group: 'whereWasTheFire'
    },
    {
        value: 'В том числе  в многоквартирных домах до 9 этажей включительно',
        label: 'В том числе  в многоквартирных домах до 9 этажей включительно',
        group: 'whereWasTheFire'
    },
    {
        value: 'В том числе  в многоквартирных домах свыше 9 этажей',
        label: 'В том числе  в многоквартирных домах свыше 9 этажей',
        group: 'whereWasTheFire'
    },
    {value: 'В частных домовладениях', label: 'В частных домовладениях', group: 'whereWasTheFire'},
    {
        value: 'В детских и образовательных учреждениях',
        label: 'В детских и образовательных учреждениях',
        group: 'whereWasTheFire'
    },
    {
        value: 'В детских и образовательных учреждениях',
    ...
    {
        value: 'В культурно-зрелищных и спортивных учреждениях',
        label: 'В культурно-зрелищных и спортивных учреждениях',
        group: 'whereWasTheFire'
    },
    {
        value: 'В учреждениях торговли и общественного питания',
        label: 'В учреждениях торговли и общественного питания',
        group: 'whereWasTheFire'
    },
    {value: 'В административных учреждениях', label: 'В административных учреждениях', group: 'whereWasTheFire'},
    {
        value: 'На других объектах с массовым сосредоточением людей',
        label: 'На других объектах с массовым сосредоточением людей',
        group: 'whereWasTheFire'
    },
    ...
    {
        value: 'Сухая трава, камыш и т.д. на землях муниципальных образований',
        label: 'Сухая трава, камыш и т.д. на землях муниципальных образований',
        group: 'whereWasTheFire'
    },
    {
        value: 'Сельскохозяйственные поля зерновых и технических культур',
        label: 'Сельскохозяйственные поля зерновых и технических культур',
        group: 'whereWasTheFire'
    },
    {
        value: 'На территории жилых зон, домовладений, в контейнерах для мусора',
        label: 'На территории жилых зон, домовладений, в контейнерах для мусора',
        group: 'whereWasTheFire'
    },
    {
        value: 'На территории предприятий, организаций, учреждений',
        label: 'На территории предприятий, организаций, учреждений',
        group: 'whereWasTheFire'
    },
    {
        value: 'На территории полигонов твердых бытовых отходов (свалки)',
        label: 'На территории полигонов твердых бытовых отходов (свалки)',
        group: 'whereWasTheFire'
    },
    {
        value: 'На строящихся объектах жилого назначения',
        label: 'На строящихся объектах жилого назначения',
        group: 'whereWasTheFire'
    },
    {
        value: 'На строящихся объектах не жилого назначения',
        label: 'На строящихся объектах не жилого назначения',
        group: 'whereWasTheFire'
    },
];
...
const rescueWorks = [
    {
        value: 'Спасение и эвакуация из горящего объекта',
        label: 'Спасение и эвакуация из горящего объекта',
        group: 'rescueWorks'
    },
    ...
    {
        value: 'Ликвидация аварий с радиационным заражением',
        label: 'Ликвидация аварий с радиационным заражением',
        group: 'rescueWorks'
    },
    {
        value: 'Ликвидация аварий с химическим заражением',
        label: 'Ликвидация аварий с химическим заражением',
        group: 'rescueWorks'
    },
    {
        value: 'Ликвидация аварий с биологическим заражением',
        label: 'Ликвидация аварий с биологическим заражением',
        group: 'rescueWorks'
    },
    {
        value: 'Ликвидация последствий террористических актов',
        label: 'Ликвидация последствий террористических актов',
        group: 'rescueWorks'
    },
    {
        value: 'Ликвидация последствий стихийных бедствий',
        label: 'Ликвидация последствий стихийных бедствий',
        group: 'rescueWorks'
    },
    {value: 'Откачка воды', label: 'Откачка воды', group: 'rescueWorks'},
    {
        value: 'Подводно-технические (водолазные работы)',
        label: 'Подводно-технические (водолазные работы)',
        group: 'rescueWorks'
    },
    {value: 'Оказание другой помощи населению', label: 'Оказание другой помощи населению', group: 'rescueWorks'},
    {
        value: 'Ликвидация последствий аварий и происшествий на водных объектах',
        label: 'Ликвидация последствий аварий и происшествий на водных объектах',
        group: 'rescueWorks'
    },
    {
        value: 'Ликвидация последствий техногенных аварий и происшествий (обрушение зданий, аварии на объектах производственной сферы и ЖКХ)',
        label: 'Ликвидация последствий техногенных аварий и происшествий (обрушение зданий, аварии на объектах производственной сферы и ЖКХ)',
        group: 'rescueWorks'
    },
...
const fireChiefRank = [
    {
        value: 'РТП– помощники начальников караулов (командиры отделений)',
        label: 'РТП– помощники начальников караулов (командиры отделений)',
        group: 'fireChiefRank'
    },
    {value: 'РТП – начальники караулов (смен)', label: 'РТП – начальники караулов (смен)', group: 'fireChiefRank'},
    {
        value: 'РТП – начальники (зам.начальников) пожарных частей',
        label: 'РТП – начальники (зам.начальников) пожарных частей',
        group: 'fireChiefRank'
    },
    {
        value: 'РТП – начальники (зам.начальников) отрядов ФПС',
        label: 'РТП – начальники (зам.начальников) отрядов ФПС',
        group: 'fireChiefRank'
    },
    {
        value: 'РТП – начальники дежурных смен (старшие оперативные) служб пожаротушения',
        label: 'РТП – начальники дежурных смен (старшие оперативные) служб пожаротушения',
        group: 'fireChiefRank'
    },
    {
        value: 'РТП – начальники управлений, отделов (отделений) организации пожаротушения и проведения АСР',
        label: 'РТП – начальники управлений, отделов (отделений) организации пожаротушения и проведения АСР',
        group: 'fireChiefRank'
    },
    {
        value: 'РТП – начальники ГУ МЧС России, заместители начальников ГУ МЧС России по ГПС',
        label: 'РТП – начальники ГУ МЧС России, заместители начальников ГУ МЧС России по ГПС',
        group: 'fireChiefRank'
    }
];
...
const extinguishingAgents = [
    {
        value: 'Пожары, ликвидированные с применением водяных стволов',
        label: 'Пожары, ликвидированные с применением водяных стволов',
        group: 'extinguishingAgents'
    },
    {
        value: 'Пожары, ликвидированные с применением пенных стволов',
        label: 'Пожары, ликвидированные с применением пенных стволов',
        group: 'extinguishingAgents'
    },
    {
        value: 'Пожары, ликвидированные с применением порошковых стволов',
        label: 'Пожары, ликвидированные с применением порошковых стволов',
        group: 'extinguishingAgents'
    },
    {
        value: 'Пожары, ликвидированные с комбинированным применением водяных, пенных или порошковых стволов',
        label: 'Пожары, ликвидированные с комбинированным применением водяных, пенных или порошковых стволов',
        group: 'extinguishingAgents'
    },
    {
        value: 'Пожары, ликвидированные с применением роботизированных установок пожаротушения',
        label: 'Пожары, ликвидированные с применением роботизированных установок пожаротушения',
        group: 'extinguishingAgents'
    },
    {
        value: 'Пожары, ликвидированные с применением огнетушителей',
        label: 'Пожары, ликвидированные с применением огнетушителей',
        group: 'extinguishingAgents'
    },
...
const usingHydrants = [
    {
        value: 'Потушено пожаров с установкой на пожарный гидрант',
        label: 'Потушено пожаров с установкой на пожарный гидрант',
        group: 'usingHydrants'
    },
    {
        value: 'Потушено пожаров с установкой на пожарный водоем',
        label: 'Потушено пожаров с установкой на пожарный водоем',
        group: 'usingHydrants'
    },
    {
        value: 'Потушено пожаров с организацией подвоза воды',
        label: 'Потушено пожаров с организацией подвоза воды',
        group: 'usingHydrants'
    },
    {
        value: 'Потушено пожаров с организацией подачи воды в перекачку',
        label: 'Потушено пожаров с организацией подачи воды в перекачку',
        group: 'usingHydrants'
    }
];
